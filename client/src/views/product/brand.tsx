      ...
      <div className="max-w-6xl mx-auto px-3 md:px-0 ">
        ...
        {loading ? (
          ...
          <div className="flex justify-between items-center mt-6 mb-2">
            ...
            <div className="relative block md:hidden" onClick={() => setOpen((prev) => !prev)}>
              <IoFilter />
              {open && (
                <div className="absolute right-0 top-1 mt-2 w-40 bg-surface rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.1),0_0_10px_rgba(0,0,0,0.05)] z-50 overflow-hidden">
                  <div className="text-text text-xs flex flex-col gap-3 p-2">
